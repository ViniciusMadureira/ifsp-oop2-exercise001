...
class Product:
    ...
    def __init__(self, name: str = "", description: str = "", value: float = None, category: Category = None):
        self.__name = name
    ...
    def is_valid(self):
        return self.__name != None and self.__description != None and self.__value != None and self.__category != None

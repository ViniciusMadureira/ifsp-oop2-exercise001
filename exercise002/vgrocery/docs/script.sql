...
INSERT INTO products (name, description, value, picture, id_category) VALUES
	('Aveia em Flocos Nestlé 170g', 'É um alimento saudável e com alto teor de fibras. É feito com Cereal Integral, além de ser rico em fibras e proteínas. Experimente com frutas picadas ou amassadas, fica uma delícia!', 3.95, 'aveia_em_flocos_nestle_170g.png', 1),
	('Carne Caldo Tablete Maggi Equilibrium 57g', 'O Caldo de Carne Maggi Equilibrium é muito bom para incrementar o sabor dos seus pratos. Além de versátil, apresenta 31% menos sódio que a versão regular.', 1.35, 'carne_caldo_tablete_maggi_equilibrium_57g.jpg', 2),
	('Ketchup Hemmer Tradicional 1kg', 'Utilizado para realçar o sabor de variados pratos: assados, peixes, fritadas, arroz e salgadinhos. É presença quase obrigatória em comidas rápidas, como hambúrgueres e outros tipos de sanduíches, pastéis, pizzas, petiscos e batatas fritas. Porção de 12g (1 colher de sopa) = 12kcal.', 11.49, 'ketchup_hemmer_tradicional_1kg.jpg', 2),
	('Óleo de Soja Liza Pet 900ml', 'Este óleo possui um equilíbrio de gorduras monoinsaturadas e é comumente utilizado na preparação de receitas culinárias ou até mesmo para fins cosméticos, fornecendo propriedades essenciais no funcionamento do organismo, dentre elas o auxílio em funções cardíacas e regulação do coleterol.', 3.99, 'oleo_de_soja_liza_pet_900ml.png', 1),
	('Sal Refinado Cisne Pacote 1kg', 'Recomendado para diversas aplicações alimentícias, pode ser encontrado em embalagens variadas e também com teor de sódio reduzido, sempre seguindo rigorosamente a legislação de adição de iodo.', 2.29, 'sal_refinado_cisne_pacote_1kg.jpg', 1),
	('Bebida Láctea Fermentada Sabor Morango Batavo 180g', 'Sabor e praticidade para o seu dia! Nossas Bebidas Lácteas Batavo são gostosas, práticas e prontas pra você levar contigo para onde for! Contém aromatizante sintético idêntico ao natural. Porção de 180g (1 unidade) = 140kcal.', 1.99, 'bebida_lactea_fermentada_sabor_morango_batavo_180g.png', 4),

...
class Ui_frmProducts(object):
    def setupUi(self, frmProducts):
        ...
        self.pteProductValue.setGeometry(QtCore.QRect(610, 390, 350, 41))
        ...
        self.pteProductDescription.setStyleSheet("border-width: 1px; border-style: solid; border-color: lightgray")
        ...
        self.lblProductValueValidation.setGeometry(QtCore.QRect(610, 430, 350, 20))
        font = QtGui.QFont()
        font.setFamily("Droid Sans")
        font.setPointSize(8)
        font.setBold(False)
        ...
        frmProducts.setTabOrder(self.btnProductPicture, self.pteProductName)
        ...
        frmProducts.setTabOrder(self.pteProductValue, self.cbxProductCategories)
    ...
    def retranslateUi(self, frmProducts):
        ...
        self.btnProductsDelete.setText(_translate("frmProducts", " Deletar"))
        ...
        self.lblProductValueValidation.setText(_translate("frmProducts", "Insira um valor entre R$0,00 e R$100.000,00."))
import resources_rc

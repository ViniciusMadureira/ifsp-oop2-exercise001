...
class Ui_frmProducts(object):
    def setupUi(self, frmProducts):
        ...
        frmProducts.setFocusPolicy(QtCore.Qt.StrongFocus)
        icon = QtGui.QIcon()
...
"selection-color: white;")
        ...
        self.lblTblProductsEmpty.setGeometry(QtCore.QRect(50, 160, 361, 291))
        font = QtGui.QFont()
        font.setFamily("Droid Sans")
        font.setPointSize(12)
        font.setBold(False)
        ...
        self.pteProductsSearch.setGeometry(QtCore.QRect(30, 60, 401, 31))
        ...
        self.btnProductsSearchClear.setGeometry(QtCore.QRect(403, 64, 24, 24))
        font = QtGui.QFont()
        font.setFamily("Droid Sans")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.btnTblProductsUpdate = QtWidgets.QToolButton(frmProducts)
        self.btnTblProductsUpdate.setGeometry(QtCore.QRect(439, 60, 31, 31))
        font = QtGui.QFont()
        font.setFamily("Droid Sans")
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.btnTblProductsUpdate.setFont(font)
        self.btnTblProductsUpdate.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.btnTblProductsUpdate.setStyleSheet("")
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/refresh_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnTblProductsUpdate.setIcon(icon7)
        self.btnTblProductsUpdate.setIconSize(QtCore.QSize(24, 24))
        self.btnTblProductsUpdate.setToolButtonStyle(QtCore.Qt.ToolButtonTextBesideIcon)
        self.btnTblProductsUpdate.setAutoRaise(False)
        self.btnTblProductsUpdate.setArrowType(QtCore.Qt.NoArrow)
        self.btnTblProductsUpdate.setObjectName("btnTblProductsUpdate")
        ...
        self.btnTblProductsUpdate.raise_()
    ...
    def retranslateUi(self, frmProducts):
        ...
        self.btnTblProductsUpdate.setToolTip(_translate("frmProducts", "Atualizar Tabela"))
        self.btnTblProductsUpdate.setAccessibleName(_translate("frmProducts", "btnTblProductsUpdate"))
        self.btnTblProductsUpdate.setText(_translate("frmProducts", " Voltar"))
        self.btnTblProductsUpdate.setShortcut(_translate("frmProducts", "Ctrl+B"))
import resources_rc

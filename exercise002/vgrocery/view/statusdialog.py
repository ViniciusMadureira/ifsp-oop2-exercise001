...
class Ui_dlgStatus(object):
    def setupUi(self, dlgStatus):
        ...
        self.lblStatusIcon.setPixmap(QtGui.QPixmap(":/dialog-information_icon.png"))
        ...
        self.btnBack.setGeometry(QtCore.QRect(280, 140, 100, 30))
        self.btnBack.setMinimumSize(QtCore.QSize(100, 30))
        self.btnBack.setMaximumSize(QtCore.QSize(100, 30))
        self.btnBack.setBaseSize(QtCore.QSize(100, 30))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, dlgStatus):
        ...
        dlgStatus.setWindowTitle(_translate("dlgStatus", "Aviso"))
        self.lblStatusText.setText(_translate("dlgStatus", "Objeto inserido com sucesso!"))
        self.btnBack.setToolTip(_translate("dlgStatus", "Ok"))
        self.btnBack.setAccessibleName(_translate("dlgStatus", "btnBack"))
